...
CREATE TABLE `tblroom` (
  ...
  `tblFloorid` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_Room_Floor` (`tblFloorid`),
  CONSTRAINT `fk_Room_Floor` FOREIGN KEY (`tblFloorid`) REFERENCES `tblfloor` (`id`)
...
INSERT INTO `tblroom` VALUES (1,'Living Room','Spacious living area',1);
